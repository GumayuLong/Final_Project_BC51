...
export default function RoomDetail() {
        ...
        <>
          <div className="col-6 mb-5">
            <div className="d-flex align-items-start">
              {element.avatar ? (
                <img src={element.avatar} className="comment__img" />
              ) : (
                <img
              ...
              <div className="ml-3">
                <h6 className="font-semibold text-base tracking-wide text-gray-900">
                  ...
                  <span className="font-normal text-sm text-gray-500">
                    {dayjs(element.ngayBinhLuan).format("DD/MM/YYYY")}
                  </span>
                </h6>
  ...
  return (
    <React.Fragment>
            ...
            <div style={{ position: "sticky", top: "1rem" }}>
              ...
              >
                ...
                <div className="border-b pt-2 mx-3">
                  <div className="d-flex justify-content-between py-1">
                    <div className="underline text-gray-600 sub-title">
                      $ {detail.giaTien} x {numberOfDays} đêm
                    </div>
                    <div>
                      <span>{detail.giaTien * numberOfDays}</span> $
                    </div>
                  </div>
                  <div className="d-flex justify-content-between py-1">
                    <div className="underline text-gray-600 sub-title">
                ...
                <div className="d-flex justify-content-between items-center text-lg font-semibold mb-3 mx-3">
                  ...
                  <div>{detail.giaTien * numberOfDays + serviceCost} $</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="container mb-5" onSubmit={handleSubmit}>
        <hr />
        <div className="row">
          <div className="col-6">
          ...
          <div className="col-12 d-flex justify-content-end">
            <button className="btn btn-success mt-3">Add comment</button>
          </div>
        </div>
      </section>
    </React.Fragment>
